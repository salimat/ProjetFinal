...
<button class="btn btn-default pull-right"  style="margin-top:20px;"  onclick="alert('prelevement du Patient {{$patients->nom_per. ' ' .$patients->prenom_per}} validé')">
      <i class="glyphicon glyphicon-check"> <input type="submit" name="" value="Valider"></i></button>
